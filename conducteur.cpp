...
Conducteur::Conducteur(std::string nom, Voiture voiture):_nom(nom), _voiture(voiture){
    _experience=0;
};

Conducteur::Conducteur(std::string nom, int experience, Voiture voiture): _nom(nom), _experience(experience), _voiture(voiture){};
